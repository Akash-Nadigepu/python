...
class WizReportAnalyzer:
    ...
    def add_age_column(self) -> None:
        ...
        self.df['Age_Days'] = self.df.apply(calculate_age, axis=1)
        
        # Count how many have valid ages
        valid_ages = self.df['Age_Days'].notna().sum()
        ...
        try:
            ...
            if 'DB' in self.teams_data:
                ...
                summary_data.append([
                    ...
                    '',
                    '',
                    team_counts['SRE']['Total'],
                    '',
                    '',
                    '',
                    team_counts['Dev']['Total'],
                    '',
                    '',
                    team_counts['DB']['Total'],
                    ''
                ])
