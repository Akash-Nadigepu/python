...
class WizReportAnalyzer:
    ...
    def add_age_column(self) -> None:
        """Calculate and add Age column to the DataFrame."""
        ...
        def calculate_age(row):
            ...
            # Parse FirstDetected date with UTC timezone
...
def main():
    ...
    if len(sys.argv) != 2:
        ...
        print("=" * 60)
        print("\n❌ Usage: python wiz_analyzer.py <input_csv_file>")
        print("Example: python wiz_analyzer.py wiz_report.csv\n")
        sys.exit(1)
